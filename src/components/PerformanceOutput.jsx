...
const PerformanceOutput = React.memo(
  ({
    ...
    }, [optimizedOutputJson, unoptimizedOutputJson]);
      ...
      for (const metric of Object.keys(performanceValues)) {
        ...
        tableRows.push(
          <div className="flex" key={metric}>
            <div
              className={`font-semibold text-center w-[125px] border ${
                metric == "total" ? "bg-slate-200" : ""
              }`}
            >
              {performanceValues[metric].title}
            </div>
            <div
              className={`text-center border ${cellWidth} ${
                metric == "total" ? "bg-slate-200" : ""
              }`}
            >
            ...
            {showDelta ? (
              <div
                className={`text-center w-[70px] border ${textColor} ${
                  metric == "total" ? "bg-slate-200" : ""
                }`}
              >
                {deltaText}
          ...
          <div className="w-20vw mr-auto text-xs">
            <div className="my-5">
              ...
              <span className="text-slate-500 text-xs">
                Total (Objective Value) = Headway Deviation + Slack Penalty
              </span>
            </div>
            <div className="my-5">
              <span className="text-base tracking-tight leading-8">
              ...
              <div>
                ...
                <span className="text-slate-500 text-xs">
                  This is the standard metric by transport operators.
                </span>
              </div>
            </div>
          </div>
